...
public class Movie {
	private int id,running_time,production_cost,north_america_box_office,world_box_office,korean_number_of_audience;
	long n;
	private String genre,director,scenario,title,producer,actor,music,rate;
	private Date begin_filming,end_filming,release_date;
	private Timestamp w_date,u_date;
